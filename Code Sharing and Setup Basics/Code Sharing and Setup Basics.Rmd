...
sourcing the same file in any coding and analysis. It should be noted
that, although a /data folder is sufficient, its good to think about
what happens to data once you start collaborating and how to manage any
changes to a data table. Especially if you are working across multiple
packages and repositories, there is nothing more time consuming shifting
through a git history to work out which csv file the team should be
using.
